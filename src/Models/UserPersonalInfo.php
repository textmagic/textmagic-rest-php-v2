...
/**
 * UserPersonalInfo Class Doc Comment
 *
 * @category Class
 * @package  TextMagic
 * @author   OpenAPI Generator team
 ...
 */
class UserPersonalInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserPersonalInfo';
    ...
    */
     ...
     * Sets avatarUrl
     *
     * @param string|null $avatarUrl URL to user's avatar image.
     *
     * @return self
     */
    public function setAvatarUrl($avatarUrl)
    {
        if (is_null($avatarUrl)) {
            array_push($this->openAPINullablesSetToNull, 'avatarUrl');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('avatarUrl', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
