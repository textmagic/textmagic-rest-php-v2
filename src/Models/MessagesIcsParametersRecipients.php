 ...
 */
class MessagesIcsParametersRecipients implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MessagesIcs_parameters_recipients';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('filteredViews', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($filteredViews)) {
            throw new \InvalidArgumentException('non-nullable filteredViews cannot be null');
        }
