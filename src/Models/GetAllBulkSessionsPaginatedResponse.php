 ...
 */
class GetAllBulkSessionsPaginatedResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetAllBulkSessionsPaginatedResponse';
