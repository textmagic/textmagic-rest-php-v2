 ...
 */
class GetAllOutboundMessagesPaginatedResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetAllOutboundMessagesPaginatedResponse';
