 ...
 */
class SearchOutboundMessagesPaginatedResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SearchOutboundMessagesPaginatedResponse';
