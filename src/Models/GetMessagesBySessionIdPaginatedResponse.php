 ...
 */
class GetMessagesBySessionIdPaginatedResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetMessagesBySessionIdPaginatedResponse';
