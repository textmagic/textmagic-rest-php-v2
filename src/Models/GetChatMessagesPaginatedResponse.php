 ...
 */
class GetChatMessagesPaginatedResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetChatMessagesPaginatedResponse';
