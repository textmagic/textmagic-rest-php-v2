...
class UpdateContactInputObject implements ModelInterface, ArrayAccess
{
     ...
     * Sets lists
     *
     * @param string $lists Comma-separated [list](https://docs.textmagic.com/#section/Lists) ID. Each contact must be assigned to at least one list.
     *
     * @return $this
     */
     ...
     * Sets country
     *
     * @param string $country The 2-letter ISO country code for local phone numbers, used when **local** is set to true.
     *
     * @return $this
     */
