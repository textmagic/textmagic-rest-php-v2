 ...
 */
class SearchChatsByReceipentPaginatedResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SearchChatsByReceipentPaginatedResponse';
