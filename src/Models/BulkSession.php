 ...
 */
class BulkSession implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BulkSession';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('itemsProcessed', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($itemsProcessed)) {
            array_push($this->openAPINullablesSetToNull, 'itemsProcessed');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('itemsProcessed', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    {
        if (is_null($itemsTotal)) {
            array_push($this->openAPINullablesSetToNull, 'itemsTotal');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('itemsTotal', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
