 ...
 */
class GetOutboundMessagesHistoryPaginatedResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetOutboundMessagesHistoryPaginatedResponse';
    ...
    */
    ...
    {
        if (is_null($lastId)) {
            array_push($this->openAPINullablesSetToNull, 'lastId');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('lastId', $nullablesSetToNull);
            if ($index !== FALSE) {
