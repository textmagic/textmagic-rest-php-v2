 ...
 */
class SendPhoneVerificationCodeResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SendPhoneVerificationCodeResponse';
    ...
    {
        $this->setIfExists('verifyId', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($verifyId)) {
            throw new \InvalidArgumentException('non-nullable verifyId cannot be null');
        }
