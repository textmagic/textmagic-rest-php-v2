 ...
 */
class MessagesIcsTextParameters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MessagesIcs_textParameters';
    ...
    public const ENCODING_UTF_16_BE = 'UTF-16BE';
    ...
    */
    ...
    {
        if (is_null($chars)) {
            array_push($this->openAPINullablesSetToNull, 'chars');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('chars', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
