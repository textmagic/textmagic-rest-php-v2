...
/**
 * ScheduleEmailCampaignRequestRecipients Class Doc Comment
 *
 * @category Class
 ...
 */
class ScheduleEmailCampaignRequestRecipients implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'scheduleEmailCampaign_request_recipients';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['contactIds'] === null) {
            $invalidProperties[] = "'contactIds' can't be null";
        }
     ...
     * Sets contactIds
     *
     * @param int[] $contactIds Array of contact IDs to send to.
     *
     * @return self
     */
     ...
     * Sets groupIds
     *
     * @param int[] $groupIds Array of group IDs to send to.
     *
     * @return self
     */
