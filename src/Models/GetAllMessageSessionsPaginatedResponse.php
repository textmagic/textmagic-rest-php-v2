 ...
 */
class GetAllMessageSessionsPaginatedResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetAllMessageSessionsPaginatedResponse';
