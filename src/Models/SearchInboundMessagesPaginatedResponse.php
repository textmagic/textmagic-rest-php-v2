 ...
 */
class SearchInboundMessagesPaginatedResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SearchInboundMessagesPaginatedResponse';
