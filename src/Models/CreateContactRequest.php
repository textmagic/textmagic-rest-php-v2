...
class CreateContactRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets lists
     *
     * @param string|null $lists Contact [list](https://docs.textmagic.com/#tag/Lists) ID. Each contact must be assigned to at least one list.
     *
     * @return self
     */
     ...
     * Sets country
     *
     * @param string|null $country The 2-letter ISO country code for local phone numbers, used when local is  set to true. Default is the account country.
     *
     * @return self
     */
