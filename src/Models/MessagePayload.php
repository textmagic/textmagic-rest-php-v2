 ...
 */
class MessagePayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MessagePayload';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('mediaPreview', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($mediaPreview)) {
            throw new \InvalidArgumentException('non-nullable mediaPreview cannot be null');
        }
